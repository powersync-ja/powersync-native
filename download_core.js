...
const versionHashes = {
  "powersync_x64.dll":
    "5efaa9ad4975094912a36843cb7b503376cacd233d21ae0956f0f4b42dcb457b",
  "libpowersync_x64.so":
    "e9d78620d69d3cf7d57353891fe0bf85b79d326b42c4669b9500b9e610388f76",
  "libpowersync_aarch64.so":
    "0d84c0dc0134fc89af65724d11e2c45e3c15569c575ecda52d0ec2fa2aeec495",
  "libpowersync_x64.dylib":
    "9b484eaf361451f7758ca6ad53190a73563be930a8f8a39ccefd29390046ef6c",
  "libpowersync_aarch64.dylib":
    "bfb4f1ec207b298aff560f1825f8123d24316edaa27b6df3a17dd49466576b92",
};
...
if (platform === "win32") {
  ...
  asset =
    OS.arch() === "x64" ? "libpowersync_x64.so" : "libpowersync_aarch64.so";
...
const destinationPath = path.resolve("assets", destination);
...
const download = async () => {
  ...
  await finished(
    Readable.fromWeb(response.body).pipe(file.createWriteStream())
  );
  await file.close();
